...
cad+="Ingrese la opción correspondiente para obtener el codigo del servicio\n";
 ...
 do {
  ...
  switch (opcion)
  {
  case 1:FabricaVehiculo.crearFabricaVehiculo(taxi);// el llama el metodo estatico 
   break;
 case 2:FabricaVehiculo.crearFabricaVehiculo(buses);
   break;
 case 3:FabricaVehiculo.crearFabricaVehiculo(busetas);
   break;
